...
export const QUESTIONS = [
  ...
  q('k20', 'kuttsuki', '（　）が とんでいます。', ['ちょうちょ', 'ちょうちょは'], 0, '🦋', 'ちょうちょが とんでいます'),
  q('k21', 'kuttsuki', 'うみで（　）を みつけました。', ['えび', 'へび'], 0, '🦐', 'うみで えびを みつけました'),
  q('k22', 'kuttsuki', '（　）は もりに います。', ['へび', 'えび'], 0, '🐍', 'へびは もりに います'),
  q('k23', 'kuttsuki', '（　）を つくります。', ['おりがみ', 'をりがみ'], 0, '🎎', 'おりがみを つくります'),
  q('k24', 'kuttsuki', '（　）を かぞえます。', ['おほしさま', 'をほしさま'], 0, '⭐', 'おほしさまを かぞえます'),
  ...
  q('s05', 'sokuon', '（　）を よみます。', ['ざっし', 'ざし'], 0, '📰', 'ざっしを よみます'),
  q('s06', 'sokuon', '（　）から めが でました。', ['ねっこ', 'ねこ'], 0, '🌱', 'ねっこから めが でました'),
  ...
  q('s13', 'sokuon', '（　）が かぜで ゆれます。', ['はっぱ', 'はぱ'], 0, '🍃', 'はっぱが かぜで ゆれます'),
  q('s14', 'sokuon', 'まいにち（　）を かきます。', ['にっき', 'にき'], 0, '📓', 'まいにち にっきを かきます'),
  q('s15', 'sokuon', 'いぬが（　）を ふります。', ['しっぽ', 'しぽ'], 0, '🐕', 'いぬが しっぽを ふります'),
  q('s16', 'sokuon', 'けっこんの（　）を かざります。', ['はなたば', 'はなたっば'], 0, '💐', 'けっこんの はなたばを かざります'),
