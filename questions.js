...
export const QUESTIONS = [
  ...
  q('y13', 'youon', '（　）もんだいです。', ['やさしい', 'ゃさしい'], 0, '🔢', 'やさしい もんだいです'),
  q('y14', 'youon', '（　）が ふっています。', ['ゆき', 'ゅき'], 0, '❄️', 'ゆきが ふっています'),
  q('y15', 'youon', '（　）に ねます。', ['よる', 'ょる'], 0, '🌙', 'よるに ねます'),
  q('y16', 'youon', '（　）に のぼります。', ['やま', 'ゃま'], 0, '⛰️', 'やまに のぼります'),
